...
async function getFare(pickup,destination){
  ...
  const fare = {
    car: Math.round(baseFare.car + (perKmRate.car * distanceInKm) + (perMinuteRate.car * timeInMin)),
    motorcycle: Math.round(baseFare.motorcycle + (perKmRate.motorcycle * distanceInKm) + (perMinuteRate.motorcycle * timeInMin)),
    auto: Math.round(baseFare.auto + (perKmRate.auto * distanceInKm) + (perMinuteRate.auto * timeInMin)),
  };
